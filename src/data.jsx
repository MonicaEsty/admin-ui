...
export const bills = [
  {
    ...
    description:
      "For advanced security and more flexible controls, the Professional plans help you scale design process company-wide.",
    icon: <Icon.Figma width={28} height={28} />,
    date: "15",
    month: "May",
  ...
  },
  {
    ...
    description:
      "For advanced security and more flexible controls, the Professional plans help you scale design process company-wide.",
    icon: <Icon.Adobe width={36} height={24} />,
    date: "16",
    month: "June",
...
export const transactions = [
  {
    ...
    icon: <Icon.Gamepad />,
    arrow: (
      <div className="text-special-red2">
